...
<body>
    ...
    <div class="container overflow-hidden" style="min-height: 100vh; display: flex; flex-direction: column; text-align: center; padding-top: 70px;">
        ...
        <div class="row gy-5" style="padding-bottom: 30px">
            <div class="col-6">
                <div class="position-relative">
                    <div class="text-center" style="padding: 30px">
                        <img src="{{url('/images/productImage.jpg')}}" class="rounded" alt="">
                        <div class="p-3 border-0 bg-ligt">Product Name</div>
                        <figcaption class="figure-caption">Short product describe.</figcaption>
                    </div>
                    <div class="bd-example position-absolute top-100 start-50 translate-middle">
                        <button type="button" class="btn btn-secondary sticky-top" data-bs-toggle="modal" data-bs-target="#view_details" style="border-radius: 36px;">View Details</button>
                    </div>
                </div>
            </div>
